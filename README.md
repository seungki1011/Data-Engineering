> 매일 공부 내용을 기록하기 위한 리포지토리입니다.
>
> 주로 데이터 엔지니어링/백엔드 기술 스택에 대한 내용을 다룹니다.

---

# :truck: ​블로그로 포스트 이전 예정

### 블로그 : [https://seungki1011.github.io/](https://seungki1011.github.io/)

### 옮기는 이유

* 깃헙 마크다운 UI의 불편함
* 같은 레포지토리 내에서 하나의 문서 -> 다른 문서로 가는 경우 프래그먼트(fragment)가 정상적으로 동작하지 않는다
  * 정상적으로 동작시키기 위해서는 전체 URL 경로가 아니라 상대 경로를 사용해야한다
    * 예) `"database/(003)%20Relational%20Database%202#12-acid"`
    * 심지어 문서가 긴 경우 이미지 로딩 때문에 의도한 문서의 구간이 아니라 이상한 위치로 이동시켜주는 문제가 있음 

* TOC를 확인하기 위해서 버튼을 눌러야한다. Sticky TOC도 아니라서 다시 확인하기 위해서는 최상단으로 이동해야한다
* 가끔씩 ** {볼드체를 적용할 텍스트} ** 가 제대로 적용되지 않는다
* 하위 불릿간 간격이 너무 좁아서 가독성이 떨어진다
* 내용 추가 순서 확인의 불편함

<br>

기존 내용을 정리하고 유지할지, 블로그에 동시에 올릴지 고민중.
...
<h3>2. 🌐 네트워크(Network)와 HTTP</h3>
  ...
  - <details>
      ...
      * [웹 통신](network%20and%20http/(002)HTTP/README.md#1-%EC%9B%B9-%ED%86%B5%EC%8B%A0)
         * 인터넷(Internet)
      ...
      * [HTTP](network%20and%20http/(002)HTTP/README.md#2-http)
         * HTTP 소개
         * Client-Server
         ...
         * HTTP Message
      * [HTTP Method](network%20and%20http/(002)HTTP/README.md#3-http-method)
         ...
         * [HTTP 메서드의 활용](network%20and%20http/(002)HTTP/README.md#35-http-%EB%A9%94%EC%84%9C%EB%93%9C%EC%9D%98-%ED%99%9C%EC%9A%A9)
           ...
           * HTTP API 설계
             ...
             * PUT - 신규 자원 등록
             * HTML Form 사용
      * [HTTP Status Code](network%20and%20http/(002)HTTP/README.md#4-http-status-code)
         * 1xx, 2xx
         * [3xx](network%20and%20http/(002)HTTP/README.md#42-3xxredirection)
           * 3xx - Permanent Redirect
           * 3xx - Temporary Redirect
         * 4xx, 5xx
      * [HTTP Header](network%20and%20http/(002)HTTP/README.md#5-http-header)
         ...
         * General, Request, Response Header
           ...
           * 특별 정보
           * 인증 정보
      * [쿠키(Cookie)](network%20and%20http/(002)HTTP/README.md#6-cookie)
         * [쿠키 소개](network%20and%20http/(002)HTTP/README.md#61-%EC%BF%A0%ED%82%A4-%EC%86%8C%EA%B0%9C)
         * Cookie - Expiration
         * Cookie - Domain
         * Cookie - Path
         * Cookie - Secure
      * [캐시(Cache)](network%20and%20http/(002)HTTP/README.md#7-cache-header)
...
<h3>3. 🧩 자료구조와 알고리즘(Data Structure and Algorithm)</h3>
  ...
  - <details>
    ...
    * [Array](algorithm%20and%20data%20structure/(001)DataStructure/(001)Array)
       * [자료구조(Data Structure)](algorithm%20and%20data%20structure/(001)DataStructure/(001)Array#1-%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0data-structure)
         ...
         * [Big-O 표기법](algorithm%20and%20data%20structure/(001)DataStructure/(001)Array#12-big-o-%ED%91%9C%EA%B8%B0)
           * Big-O 설명
           * Big-O 표기법 특징
       * [배열(`Array`)](algorithm%20and%20data%20structure/(001)DataStructure/(001)Array#2-%EB%B0%B0%EC%97%B4array)
         * [배열 설명](algorithm%20and%20data%20structure/(001)DataStructure/(001)Array#21-%EB%B0%B0%EC%97%B4-%EC%84%A4%EB%AA%85)
         * [배열 기능 구현](algorithm%20and%20data%20structure/(001)DataStructure/(001)Array#22-%EB%B0%B0%EC%97%B4-%EA%B8%B0%EB%8A%A5-%EA%B5%AC%ED%98%84)
         * [배열의 성능과 한계](algorithm%20and%20data%20structure/(001)DataStructure/(001)Array#23-%EB%B0%B0%EC%97%B4%EC%9D%98-%EC%84%B1%EB%8A%A5%EA%B3%BC-%ED%95%9C%EA%B3%84)
    * [List](algorithm%20and%20data%20structure/(001)DataStructure/(002)List)
       * [`ArrayList`](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#1-arraylist)
         * [`ArrayList` 설명](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#11-arraylist-%EC%84%A4%EB%AA%85)
         * [`ArrayList` 구현](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#12-arraylist-%EA%B5%AC%ED%98%84)
         * [`ArrayList`의 한계](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#13-arraylist%EC%9D%98-%ED%95%9C%EA%B3%84)
       * [`LinkedList`](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#2-linkedlist)
         * [`LinkedList` 설명](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#21-linkedlist-%EC%84%A4%EB%AA%85)
           * 앞에 데이터(노드) 추가
           * 앞에 데이터(노드) 삭제
           * 특정 위치에 데이터(노드) 추가
         * [`LinkedList` 구현](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#22-linkedlist-%EA%B5%AC%ED%98%84)
       * [`ArrayList` vs `LinkedList`](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#3-arraylist-vs-linkedlist)
       * [`Collection` 프레임워크 소개](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#4-collection-%ED%94%84%EB%A0%88%EC%9E%84%EC%9B%8C%ED%81%AC-%EC%86%8C%EA%B0%9C)
       * [`List` 인터페이스](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#5-list-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4)
         * [`List` 설명](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#51-list-%EC%84%A4%EB%AA%85)
         * [추가적인 성능비교](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#52-%EC%B6%94%EA%B0%80%EC%A0%81%EC%9D%B8-%EC%84%B1%EB%8A%A5-%EB%B9%84%EA%B5%90)
           * `MyArrayList` vs `ArrayList`
           * `ArrayList` vs `LinkedList`
    
         * [`List` 인터페이스 사용해보기](algorithm%20and%20data%20structure/(001)DataStructure/(002)List#53-list-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4-%EC%82%AC%EC%9A%A9%ED%95%B4%EB%B3%B4%EA%B8%B0)
    * [Set](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set)
       * [`Set`](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#1-set)
         * [`Set` 설명](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#11-set-%EC%84%A4%EB%AA%85)
         * [`Set` 간단 구현](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#12-set-%EA%B0%84%EB%8B%A8-%EA%B5%AC%ED%98%84)
       * [Hash Algorithm](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#2-hash-algorithm)
         * [해시 알고리즘 원리](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#21-%ED%95%B4%EC%8B%9C-%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98-%EC%9B%90%EB%A6%AC)
         * [해시 충돌(Hash Collision)](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#22-%ED%95%B4%EC%8B%9C-%EC%B6%A9%EB%8F%8Chash-collision)
         * [해시 인덱스 성능](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#23-%ED%95%B4%EC%8B%9C-%EC%9D%B8%EB%8D%B1%EC%8A%A4-%EC%84%B1%EB%8A%A5)
       * [`hashCode()`](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#3-hashcode)
         * [문자열 해시 코드](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#31-%EB%AC%B8%EC%9E%90%EC%97%B4-%ED%95%B4%EC%8B%9C-%EC%BD%94%EB%93%9C)
         * [자바가 제공하는 `hashCode()`](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#32-%EC%9E%90%EB%B0%94%EA%B0%80-%EC%A0%9C%EA%B3%B5%ED%95%98%EB%8A%94-hashcode)
    
       * [`HashSet` 구현](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#4-hashset-%EA%B5%AC%ED%98%84)
       * [`Set` 인터페이스](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#5-set-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4)
         * [`Set` 인터페이스 설명](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#51-set-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4-%EC%84%A4%EB%AA%85)
         * [`Set` 인터페이스 사용해보기](algorithm%20and%20data%20structure/(001)DataStructure/(003)Set#52-set-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4-%EC%82%AC%EC%9A%A9%ED%95%B4%EB%B3%B4%EA%B8%B0)
    * [Map](algorithm%20and%20data%20structure/(001)DataStructure/(004)Map)
       * [`Map`](algorithm%20and%20data%20structure/(001)DataStructure/(004)Map#1-map)
         * [`Map` 설명](algorithm%20and%20data%20structure/(001)DataStructure/(004)Map#11-map-%EC%84%A4%EB%AA%85)
         * [`Map` 인터페이스](algorithm%20and%20data%20structure/(001)DataStructure/(004)Map#12-map-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4)
         * [`HashMap` 원리](algorithm%20and%20data%20structure/(001)DataStructure/(004)Map#13-hashmap-%EC%9B%90%EB%A6%AC)
       * [`Map` 사용하기](algorithm%20and%20data%20structure/(001)DataStructure/(004)Map#2-map-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0)
    * [Stack, Queue](algorithm%20and%20data%20structure/(001)DataStructure/(005)Stack_Queue)
       * [`Stack`](algorithm%20and%20data%20structure/(001)DataStructure/(005)Stack_Queue#1-stack)
         * [`Stack` 설명](algorithm%20and%20data%20structure/(001)DataStructure/(005)Stack_Queue#11-stack-%EC%84%A4%EB%AA%85)
         * [자바에서 제공하는 `Stack`](algorithm%20and%20data%20structure/(001)DataStructure/(005)Stack_Queue#12-%EC%9E%90%EB%B0%94%EC%97%90%EC%84%9C-%EC%A0%9C%EA%B3%B5%ED%95%98%EB%8A%94-stack)
       * [`Queue`](algorithm%20and%20data%20structure/(001)DataStructure/(005)Stack_Queue#2-queue)
         * [`Queue` 설명](algorithm%20and%20data%20structure/(001)DataStructure/(005)Stack_Queue#21-queue-%EC%84%A4%EB%AA%85)
         * [`Queue` 인터페이스](algorithm%20and%20data%20structure/(001)DataStructure/(005)Stack_Queue#22-queue-%EC%9D%B8%ED%84%B0%ED%8E%98%EC%9D%B4%EC%8A%A4)
...
<h3>1. Java</h3>
  ...
  - <details>
      ...
      * [`Collection` 프레임워크](java/(018)%20Collection#1-collection-%ED%94%84%EB%A0%88%EC%9E%84%EC%9B%8C%ED%81%AC)
      * [`Collection`](java/(018)%20Collection#2-collection)
      * [`Iterator`](java/(018)%20Collection#3-iterable-iterator)
         * [`Iterable`, `Iterator` 설명](java/(018)%20Collection#31-iterable-iterator-%EC%84%A4%EB%AA%85)
         * [`Iterator` 구현](java/(018)%20Collection#32-iterator-%EA%B5%AC%ED%98%84)
      ...
      * [`Stack`, `Queue`, `ArrayDeque`](java/(018)%20Collection#7-stack-queue-arraydeque)
         * `ArrayDeque`
      * [`Comparable`, `Comparator`](java/(018)%20Collection#8-comparable--comparator)
         * [`Comparator`](java/(018)%20Collection#81-comparator)
         * [`Comparable`](java/(018)%20Collection#82-comparable)
         * `Comparator`, `Comparable` 예시
      * [컬렉션 유틸(`Collections`)](java/(018)%20Collection#9-%EC%BB%AC%EB%A0%89%EC%85%98-%EC%9C%A0%ED%8B%B8collections)
         * [정렬, 최댓값, 최소값](java/(018)%20Collection#91-%EC%A0%95%EB%A0%AC-%EC%B5%9C%EB%8C%80%EA%B0%92-%EC%B5%9C%EC%86%8C%EA%B0%92)
         * [컬렉션 생성](java/(018)%20Collection#92-%EC%BB%AC%EB%A0%89%EC%85%98-%EC%83%9D%EC%84%B1)
...
<h3>1. 스프링 프레임워크(Spring Framework)</h3>
  ...
  - <details>
      ...
      * [Introduction](spring/(001)Spring%20Introduction#1-introduction)
         * ```Spring```, ```SpringBoot``` 소개
         * ```Gradle```
         * MVC Pattern
      * [Spring Boot Project Configuration](spring/(001)Spring%20Introduction#2-spring-boot-project-configuration)
         * Spring Boot 프로젝트 생성하기
         * 실행 확인하기
         * View 설정하기
         * 빌드 후 실행
      * [Spring 웹 개발](spring/(001)Spring%20Introduction#3-spring-%EC%9B%B9-%EA%B0%9C%EB%B0%9C)
         * Static Contents
         * MVC & Template Engine
         * API
      * [회원 관리 기능 개발 I](spring/(001)Spring%20Introduction#4-%ED%9A%8C%EC%9B%90-%EA%B4%80%EB%A6%AC-%EA%B8%B0%EB%8A%A5-%EA%B0%9C%EB%B0%9C-i)
         * 비즈니스 요구 사항
         * 애플리케이션 계층 구조
         * 클래스 의존 관계
         * 회원 저장소 코드, 테스트 코드
         * 회원 서비스 코드, 테스트 코드
      * [Spring Bean & Dependency](spring/(001)Spring%20Introduction#5-spring-bean--dependency)
         * Component Scan
         * 자바 코드로 스프링 빈 등록
      * [회원 관리 기능 개발 II](spring/(001)Spring%20Introduction#6-%ED%9A%8C%EC%9B%90-%EA%B4%80%EB%A6%AC-%EA%B8%B0%EB%8A%A5-%EA%B0%9C%EB%B0%9C-ii)
         * 홈 화면 추가
         * 등록
         * 조회
      * [Spring DB Access](spring/(001)Spring%20Introduction#7-spring-db-access)
         * H2 데이터베이스 Setup
         * JdbcTemplate
         * 스프링 통합 테스트
         * JPA
      * [AOP](spring/(001)Spring%20Introduction#8-aop)
         * AOP 소개
      * [전체 요약](spring/(001)Spring%20Introduction#%EC%A0%84%EC%B2%B4-%EC%9A%94%EC%95%BD)
  ...
  - <details>
      ...
      * [Object Oriented Design(객체 지향 설계)](spring/(002)Spring%20Core%20-%201#1-object-oriented-design%EA%B0%9D%EC%B2%B4-%EC%A7%80%ED%96%A5-%EC%84%A4%EA%B3%84)
         * SOLID 원칙
           * SRP
           * OCP
           * LSP
           ...
           * 요약
         * OOD와 Spring
      * [Spring 핵심 원리 I - 예제 생성](spring/(002)Spring%20Core%20-%201#2-spring-%ED%95%B5%EC%8B%AC-%EC%9B%90%EB%A6%AC-i---%EC%98%88%EC%A0%9C-%EC%83%9D%EC%84%B1)
         * 프로젝트 생성
         * 비즈니스 요구 사항과 설계
         * 회원 도메인 설계, 개발, 테스트
         * 주문과 할인 도메인 설계, 개발, 테스트
      * [Spring 핵심 원리 II - 객체 지향 적용](spring/(002)Spring%20Core%20-%201#3-spring-%ED%95%B5%EC%8B%AC-%EC%9B%90%EB%A6%AC-ii---%EA%B0%9D%EC%B2%B4-%EC%A7%80%ED%96%A5-%EC%A0%81%EC%9A%A9)
         * 새로운 할인 정책 개발
         * 관심사 분리
         * 새로운 구조와 할인 정책 적용
         * IoC, DI, 컨테이너
           ...
           * IoC, DI 컨테이너
         * 스프링으로 전환
      * [Spring Container, Bean](spring/(002)Spring%20Core%20-%201#4-spring-container--bean)
         * 스프링 컨테이너
         * 스프링 빈 조회
           * 컨테이너에 등록된 모든 빈 조회
           * 빈 조회하기
      ...
      * [Singleton Container](spring/(002)Spring%20Core%20-%201#5-singleton-container)
         * 스프링이 없는 순수한 DI 컨테이너
         * 싱글톤 패턴(Singleton Pattern)
         * 스프링의 싱글톤 컨테이너
         * 싱글톤 방식의 주의점
         * ```@Configuration```
      * [Component Scan](spring/(002)Spring%20Core%20-%201#6-component-scan)
         * ```@ComponentScan```, ```@Autowired```
         * ```@ComponentScan```의 탐색 위치와 스캔 대상
         * 필터, 중복 등록과 충돌
           * 필터
           * 중복 등록과 충돌돌
      * [Dependency Injection (DI, 의존관계 주입)](spring/(002)Spring%20Core%20-%201#7-%EC%9D%98%EC%A1%B4%EA%B4%80%EA%B3%84-%EC%9E%90%EB%8F%99-%EC%A3%BC%EC%9E%85autowired)
         * DI(의존관계 주입)
           * 생성자 주입
           * 수정자 주입
           * 필드 주입
         ...
         * ```@Autowired 필드명```, ```@Qualifier```, ```@Primary```
           ...
           * ```@Primary```
         * 조회한 빈이 모두 필요한 경우
      * [Spring Bean Lifecycle Callbacks(빈 생명주기 콜백)](spring/(002)Spring%20Core%20-%201#8-spring-bean-lifecycle-callbacks)
         * 빈 생명주기 콜백
         * 초기화, 소멸 메서드 지정
         * ```@PostConstruct```, ```@PreDestroy```
      * [Spring Bean Scope](spring/(002)Spring%20Core%20-%201#9-spring-bean-scope)
  ...
  - <details>
      ...
      * [Web Application](spring/(003)Spring%20MVC%20-%201#1-web-application)
         * Web Server, Was
         * Thread Pool
         * AJAX
         * SSR(서버 사이드 렌더링), CSR(클라이언트 사이드 렌더링)
      * [MVC(Model View Controller)](spring/(003)Spring%20MVC%20-%201#2-mvcmodel-view-controller)
         * MVC 소개
         * Front Controller
         * Front Controller 도입
         * View 분리
         ...
         * 사용성 개선
         * Adapter 도입
      * [Spring MVC](spring/(003)Spring%20MVC%20-%201#3-spring-mvc)
         * Spring MVC 구조
           * `HandlerMapping`, `HandlerAdapter`
           * `ViewResolver`
         * Spring MVC 사용해보기
         * 사용성 개선
      * [Spring MVC - 기능 살펴보기](spring/(003)Spring%20MVC%20-%201#4-spring-mvc---%EA%B8%B0%EB%8A%A5-%EC%82%B4%ED%8E%B4%EB%B3%B4%EA%B8%B0)
         * Logging
      ...
      * [Spring 메세지, 국제화 (Message, Internationalization)](spring/(003)Spring%20MVC%20-%201#5-%EC%8A%A4%ED%94%84%EB%A7%81-%EB%A9%94%EC%84%B8%EC%A7%80-%EA%B5%AD%EC%A0%9C%ED%99%94-messages-internationalization)
         * 메세지, 국제화 소개
           * 메세지
           * 국제화
         * 메세지 적용하기
           ...
           * 타임리프 메세지 적용
         * 국제화 적용하기
      * [검증(Validation)](spring/(003)Spring%20MVC%20-%201#6-%EA%B2%80%EC%A6%9Dvalidation)
         * 검증 소개
         * `BindingResult`
         * 오류 코드, 메세지 처리
           * `errors.properties`
         ...
         * Validator 분리
      * [Bean Validation](spring/(003)Spring%20MVC%20-%201#7-bean-validation)
      ...
      * [쿠키, 세션(Cookie, Session)](spring/(003)Spring%20MVC%20-%201#8-%EC%BF%A0%ED%82%A4-%EC%84%B8%EC%85%98-cookie-session)
         * 로그인을 위한 요구 사항
         * 화면과 기능 구현
           * 홈 화면
           * 회원 가입
         ...
         * 세션 사용(Seesion)
           ...
           * 세션 타임아웃
      * [필터, 인터셉터(Filter, Interceptor)](spring/(003)Spring%20MVC%20-%201#9-%ED%95%84%ED%84%B0-%EC%9D%B8%ED%84%B0%EC%85%89%ED%84%B0filter-interceptor)
         ...
         * 인터셉터 예시
           * 예시 1 - 사용자 요청 로깅
           * 예시 2 - 로그인 체크
      * [오류 페이지(Error Page)](spring/(003)Spring%20MVC%20-%201#10-%EC%98%A4%EB%A5%98-%ED%8E%98%EC%9D%B4%EC%A7%80error-page)
          * 서블릿에서의 예외 처리
            * 스프링 부트에서 제공하는 오류 페이지 기능
              * 오류 페이지 사용
              * `BasicErrorController`가 제공하는 정보
      * [API 예외 처리](spring/(003)Spring%20MVC%20-%201#11-api-%EC%98%88%EC%99%B8-%EC%B2%98%EB%A6%AC)
          * `HandlerExceptionResolver` 소개
          * 스프링이 제공하는 `ExceptionResolver`
            * `ExceptionHandlerExceptionResolver`
          * `@ControllerAdvice`
      * [스프링 타입 컨버터](spring/(003)Spring%20MVC%20-%201#12-%EC%8A%A4%ED%94%84%EB%A7%81-%ED%83%80%EC%9E%85-%EC%BB%A8%EB%B2%84%ED%84%B0)
          * `Converter`
          * `ConversionService`
          * `Converter` 사용하기
          * `Formatter`
          ...
          * 스프링 제공 `Formatter`
      * [파일 업로드](spring/(003)Spring%20MVC%20-%201#13-%ED%8C%8C%EC%9D%BC-%EC%97%85%EB%A1%9C%EB%93%9C)

    </details>
  - <details>
      <summary>4. Thymeleaf</summary>
      
      * [타임리프(Thymeleaf) 소개](spring/(004)Thymeleaf#1-%ED%83%80%EC%9E%84%EB%A6%AC%ED%94%84thymeleaf-%EC%86%8C%EA%B0%9C)
      * [타임리프의 기본 기능](spring/(004)Thymeleaf#2-%ED%83%80%EC%9E%84%EB%A6%AC%ED%94%84%EC%9D%98-%EA%B8%B0%EB%B3%B8-%EA%B8%B0%EB%8A%A5)
         ...
         * [템플릿 조각, 레이아웃(template fragment, layout)](spring/(004)Thymeleaf#2132-%EC%9E%90%EB%B0%94%EC%8A%A4%ED%81%AC%EB%A6%BD%ED%8A%B8-%EC%9D%B8%EB%9D%BC%EC%9D%B8-each)
           ...
           * 레이아웃
           * 레이아웃을 `<html>` 전체로 확장
      * [타임리프 - 스프링](spring/(004)Thymeleaf#3-%ED%83%80%EC%9E%84%EB%A6%AC%ED%94%84---%EC%8A%A4%ED%94%84%EB%A7%81)
...
<details>
  ...
  2. [트랜잭션(Transaction)](database/(004)Java_DB%20_Access#2-%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98transaction)
     ...
     * [스프링 트랜잭션 주의점](database/(004)Java_DB%20_Access#24-%EC%8A%A4%ED%94%84%EB%A7%81-%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98-%EC%A3%BC%EC%9D%98%EC%A0%90)
     * [`@Transactional` 옵션들](database/(004)Java_DB%20_Access#25-transactional-%EC%98%B5%EC%85%98%EB%93%A4)
     * [예외에 따른 트랜잭션 커밋/롤백](database/(004)Java_DB%20_Access#26-%EC%98%88%EC%99%B8%EC%97%90-%EB%94%B0%EB%A5%B8-%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98-%EC%BB%A4%EB%B0%8B%EB%A1%A4%EB%B0%B1)
     * [스프링 트랜잭션 전파(Transaction Propagation)](database/(004)Java_DB%20_Access#27-%EC%8A%A4%ED%94%84%EB%A7%81-%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98-%EC%A0%84%ED%8C%8Ctransaction-propagation)
       * [두 트랜잭션을 따로 관리](database/(004)Java_DB%20_Access#271-%EB%91%90-%ED%8A%B8%EB%9E%9C%EC%9E%AD%EC%85%98%EC%9D%84-%EB%94%B0%EB%A1%9C-%EA%B4%80%EB%A6%AC)
       * [전파 기본 옵션 `REQUIRED`](database/(004)Java_DB%20_Access#272-%EC%A0%84%ED%8C%8C-%EA%B8%B0%EB%B3%B8-%EC%98%B5%EC%85%98-required)
       * [전파 옵션 `REQUIRES_NEW`](database/(004)Java_DB%20_Access#273-%EC%A0%84%ED%8C%8C-%EC%98%B5%EC%85%98-requires_new)
       * 기타 전파 옵션
  3. [JdbcTemplate](database/(004)Java_DB%20_Access#3-jdbctemplate)
     * [예시 프로젝트(메모리 기반) 소개](database/(004)Java_DB%20_Access#31-%EC%98%88%EC%8B%9C-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8%EB%A9%94%EB%AA%A8%EB%A6%AC-%EA%B8%B0%EB%B0%98-%EC%86%8C%EA%B0%9C)
       * 도메인
       * 레포지토리
       * 스프링 부트 설정
       * [프로필(`@Profile`)](database/(004)Java_DB%20_Access#314-%ED%94%84%EB%A1%9C%ED%95%84profile)
     * [프로젝트 데이터베이스 준비](database/(004)Java_DB%20_Access#32-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-%EB%8D%B0%EC%9D%B4%ED%84%B0%EB%B2%A0%EC%9D%B4%EC%8A%A4-%EC%A4%80%EB%B9%84)
     * [JdbcTemplate 소개](database/(004)Java_DB%20_Access#33-jdbctemplate-%EC%86%8C%EA%B0%9C)
     * [JdbcTemplate 설정](database/(004)Java_DB%20_Access#34-jdbctemplate-%EC%84%A4%EC%A0%95)
     * [JdbcTemplate 적용](database/(004)Java_DB%20_Access#35-jdbctemplate-%EC%A0%81%EC%9A%A9)
       * `ItemRepository` 구현체 만들기
       * [동적 쿼리](database/(004)Java_DB%20_Access#352-%EB%8F%99%EC%A0%81-%EC%BF%BC%EB%A6%AC)
       * 구성하고 실행
     * [`NamedParameterJdbcTemplate`](database/(004)Java_DB%20_Access#36-namedparameterjdbctemplate)
     * [`SimpleJdbcInsert`](database/(004)Java_DB%20_Access#37-simplejdbcinsert)
  4. [DB Testing](database/(004)Java_DB%20_Access#4-db-testing)
     * [데이터베이스 연동](database/(004)Java_DB%20_Access#41-%EB%8D%B0%EC%9D%B4%ED%84%B0%EB%B2%A0%EC%9D%B4%EC%8A%A4-%EC%97%B0%EB%8F%99)
     * [데이터베이스 분리](database/(004)Java_DB%20_Access#42-%EB%8D%B0%EC%9D%B4%ED%84%B0%EB%B2%A0%EC%9D%B4%EC%8A%A4-%EB%B6%84%EB%A6%AC)
     * [Rollback](database/(004)Java_DB%20_Access#43-rollback)
     * [`@Transactional`](database/(004)Java_DB%20_Access#44-transactional)
     * [Embedded Mode](database/(004)Java_DB%20_Access#45-embedded-mode)
...
11. [JPQL](database/(006)JPA#11-jpql)
    * [JPQL 소개](database/(006)JPA#111-jpql-%EC%86%8C%EA%B0%9C)
    * QueryDSL 소개
    * Native SQL 소개
12. [JPQL 기본 사용법](database/(006)JPA#12-jpql-%EA%B8%B0%EB%B3%B8-%EC%82%AC%EC%9A%A9%EB%B2%95)
    * [기본 `select`문](database/(006)JPA#121-%EA%B8%B0%EB%B3%B8-select-%EB%AC%B8)
    * [`TypedQuery`, `Query`](database/(006)JPA#122-typedquery-query)
    * [결과 조회](database/(006)JPA#123-%EA%B2%B0%EA%B3%BC-%EC%A1%B0%ED%9A%8C)
    * [파라미터 바인딩(`setParameter()`)](database/(006)JPA#124-%ED%8C%8C%EB%9D%BC%EB%AF%B8%ED%84%B0-%EB%B0%94%EC%9D%B8%EB%94%A9setparameter)
    * [프로젝션(Projection)](database/(006)JPA#125-%ED%94%84%EB%A1%9C%EC%A0%9D%EC%85%98projection)
    * [페이징(Pagination)](database/(006)JPA#126-%ED%8E%98%EC%9D%B4%EC%A7%95pagination)
    * [조인(`JOIN`)](database/(006)JPA#127-%EC%A1%B0%EC%9D%B8join)
    * [서브쿼리(Subquery)](database/(006)JPA#128-%EC%84%9C%EB%B8%8C%EC%BF%BC%EB%A6%ACsubquery)
    * [조건식(Case)](database/(006)JPA#129-%EC%A1%B0%EA%B1%B4%EC%8B%9Dcase)
    * [JPQL 함수](database/(006)JPA#1210-jpql-%ED%95%A8%EC%88%98)
13. [JPQL 더 알아가기](database/(006)JPA#13-jpql-%EB%8D%94-%EC%95%8C%EC%95%84%EA%B0%80%EA%B8%B0)
    * [경로 표현식(Path Expression)](database/(006)JPA#131-%EA%B2%BD%EB%A1%9C-%ED%91%9C%ED%98%84%EC%8B%9Dpath-expression)
    * [:star: 페치 조인(`join fetch`)](database/(006)JPA#132-star-%ED%8E%98%EC%B9%98-%EC%A1%B0%EC%9D%B8join-fetch)
      * [페치 조인 소개](database/(006)JPA#1321-%ED%8E%98%EC%B9%98-%EC%A1%B0%EC%9D%B8-%EC%86%8C%EA%B0%9C)
      * [N+1 문제](database/(006)JPA#1322-n1-%EB%AC%B8%EC%A0%9C)
      * [컬렉션 페치 조인](database/(006)JPA#1323-%EC%BB%AC%EB%A0%89%EC%85%98-%ED%8E%98%EC%B9%98-%EC%A1%B0%EC%9D%B8)
      * [페치 조인의 한계](database/(006)JPA#1324-%ED%8E%98%EC%B9%98-%EC%A1%B0%EC%9D%B8%EC%9D%98-%ED%95%9C%EA%B3%84)
    * [`@NamedQuery`](database/(006)JPA#133-namedquery)
    * [벌크 연산(Bulk Operation)](database/(006)JPA#134-%EB%B2%8C%ED%81%AC-%EC%97%B0%EC%82%B0bulk-operation)
